...
# Proximity Detection and State Reset
  ...
  - Tracking Nearby Users with the `proximityMap`:
    ...
    To keep track of users in the NPC's vicinity, we will use a Map object called `proximityMap`. This stores the connection IDs of nearby users and their positions.
