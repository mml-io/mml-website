...
The same framwork can be replicated to create game NPCs, and it can be executed in just a few steps.
 ...
 _TL;DR:_
 - _You can see a demo of this project on [MServe](https://squig-npc-73c524_squig-world-d254a9.mml.world)_
...
- Animating the NPC: Bringing Your Virtual Character to Life:
...
- Proximity Detection and State Reset: Keeping the NPC Context-Aware:
