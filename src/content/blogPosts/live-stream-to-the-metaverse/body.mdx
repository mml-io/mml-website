...
_[Marco Gomez](https://x.com/TheCodeTherapy) - 2024-10-29_
...
The Cloudflare Stream service pricing system works based on the number of minutes of video delivered to your live event. On the date I'm writing this blog post, the price is $1 USD per 1,000 minutes of video delivered. That means if you're streaming a 60-minute-long live event for 30 users present in the event, there will be a total of 1800 (60 x 30) minutes of video delivered, so the event will cost a total $1.80 USD.

That means the plan you pick here won't matter too much if you're only interested in the real-time live-streaming capabilities. The plans vary according to your interest in storing videos to play them back later, but the `$5 / month` plan will serve well for the live events.
