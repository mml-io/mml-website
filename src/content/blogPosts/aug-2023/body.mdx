...
This React-based workflow was initially made available as part of the [MML React Starter project](https://github.com/mml-io/mml-react-starter-project). This project is a starting point for making an MML creation using React that is served on a WebSocket.
...
As a result, the packages can be used as dependencies in other projects. The first project that uses these dependencies is [github.com/mml-io/mml-react-space](https://github.com/mml-io/mml-react-space). This project combines the React-based workflow for creating interactive MML content with the 3D web experience, and a multi-level modular building as a starting point.
...
This project is a great starting point to explore how a platform-independent web-based virtual world can work for an experience you may already have in mind. It can be run locally and self-hosted, and using MML you can easily add more content that can be interacted with in real-time by multiple users.
