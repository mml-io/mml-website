...
<TableOfContent>
  ...
  <SubSection title="Animating On Click" />
  <SubSection title="Animating On Collision" />
</TableOfContent>
...
<video autoPlay={true} loop={true} muted>
  <source src="/images/guides/mml-with-react/animated-door-wrong.mp4" type="video/mp4" />
</video>
...
<video autoPlay={true} loop={true} muted>
  <source src="/images/guides/mml-with-react/animated-door-right.mp4" type="video/mp4" />
</video>
...
<video autoPlay={true} loop={true} muted>
  <source src="/images/guides/mml-with-react/animated-door-final.mp4" type="video/mp4" />
</video>
...
<video autoPlay={true} loop={true} muted>
  <source src="/images/guides/mml-with-react/sliding-doors.mp4" type="video/mp4" />
</video>

The key takeaway is that the `SlidingDoors`' `open` prop is dynamically set based on whether
`collidingUsers.size` is greater than zero. If there's at least one collision, the doors open and stay open.
